import { fetchOfflineCatalog, SupplierConnectionError } from './499k/client.js';
...
export async function importOfflineCatalog({env=process.env,fetcher=fetch,wait}={}) {
  ...
  if(!env.SUPPLIER_499K_API_KEY?.startsWith('499k_live_'))throw new SupplierConnectionError('LIVE_KEY_REQUIRED_FOR_IMPORT',503);
