(() => {
  ...
  window.addEventListener('olaf-profile-ready',async event=>{
    ...
    theme.innerHTML='<summary>ธีมเว็บไซต์</summary><div class="member-theme-options"><button type="button" data-theme="main">น้ำเงิน · เว็บหลัก</button><button type="button" data-theme="store">ดำเข้ม · Midnight</button></div><select hidden aria-label="ธีมโปรไฟล์"><option value="main">น้ำเงิน · เว็บหลัก</option><option value="store">ดำเข้ม · Midnight</option></select><span role="status"></span>';
